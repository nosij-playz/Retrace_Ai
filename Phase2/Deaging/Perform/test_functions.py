...
mask_file = torch.from_numpy(np.array(Image.open('Aging/assets/mask1024.jpg').convert('L'))) / 255
small_mask_file = torch.from_numpy(np.array(Image.open('Aging/assets/mask512.jpg').convert('L'))) / 255
